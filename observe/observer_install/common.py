...
from apps.observer.utils import find_observer_by_name, list_observers
...
def create_or_reuse_registration(name: str, *, force: bool) -> ObserverRecord:
    ...
    from observe.observer_cli import create_observer_record, revoke_observer_record
...
def poll_status_until(
    ...
    from observe.observer_cli import _status_label
