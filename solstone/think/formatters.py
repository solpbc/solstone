...
FORMATTERS: dict[str, tuple[str, str, bool]] = {
    ...
    "config/actions/*.jsonl": ("solstone.think.facets", "format_logs", True),
    ...
    "*/import.*/imported.jsonl": (
        "solstone.think.importers.formatting",
        "format_imported",
        True,
    ),
    # Markdown transcript imports (new convention + legacy)
    "*/import.*/*/*_transcript.md": (
        "solstone.think.markdown",
        "format_markdown",
        True,
    ),
    "*/import.*/*/imported.md": ("solstone.think.markdown", "format_markdown", True),
    ...
    "*/*/*/audio.jsonl": ("solstone.observe.hear", "format_audio", False),
    "*/*/*/*_audio.jsonl": ("solstone.observe.hear", "format_audio", False),
    ...
    "facets/*/news/*.md": ("solstone.think.markdown", "format_markdown", True),
    "reflections/weekly/*.md": ("solstone.think.markdown", "format_markdown", True),
    "imports/*/summary.md": ("solstone.think.markdown", "format_markdown", True),
    "apps/*/talents/*.md": ("solstone.think.markdown", "format_markdown", True),
}
