...
CONTRACT_FIELDS = [
    ...
    ("totals.total_transcript_duration", "total_audio_duration"),
    ("totals.total_percept_duration", "total_screen_duration"),
    ("totals.transcript_sessions", "audio_sessions"),
    ("tokens.by_model", "token_totals_by_model"),
    ("tokens.by_day", "token_usage_by_day"),
    ("facets.counts_by_day", "facet_counts_by_day"),
    ("agents.counts_by_day", "agent_counts_by_day"),
    ("days.*.transcript_duration", "audio_duration"),
    ("days.*.percept_duration", "screen_duration"),
