...
class TestBuildCogitateEnv:
    ...
    def test_vertex_service_account_sets_gac(self):
        """Vertex + vertex_credentials sets GOOGLE_APPLICATION_CREDENTIALS."""
        config = {
            "providers": {
                "google_backend": "vertex",
    ...
    def test_vertex_service_account_no_api_key(self):
        """Vertex + service account works even without GOOGLE_API_KEY in env."""
        config = {
            "providers": {
                "google_backend": "vertex",
                "vertex_credentials": "/path/to/creds.json",
    ...
    def test_vertex_no_credentials_preserves_api_key(self):
        """Vertex without vertex_credentials preserves API key behavior."""
        config = {
            "providers": {
                "google_backend": "vertex",
                "auth": {"google": "api_key"},
