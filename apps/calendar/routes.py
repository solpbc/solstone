...
@calendar_bp.route("/<day>/transcript")
...
@calendar_bp.route("/api/transcript_ranges/<day>")
...
@calendar_bp.route("/api/transcript/<day>")
...
@calendar_bp.route("/api/raw_files/<day>")
...
@calendar_bp.route("/api/media_files/<day>")
    ...
    for e in entries:
        if start_dt <= e["timestamp"] < end_dt:
            ...
            try:
                ...
                file_url = (
                    f"/app/calendar/api/serve_file/{day}/{rel_path.replace('/', '__')}"
                )
...
@calendar_bp.route("/api/serve_file/<day>/<path:encoded_path>")
...
@calendar_bp.route("/api/download_audio/<day>")
